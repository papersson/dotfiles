$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/patrikpersson/Library/Application Support/carapace/bin" } | prepend "/Users/patrikpersson/Library/Application Support/carapace/bin")
